// Generated by Bisonc++ V2.09.03 on Thu, 06 Feb 2014 22:17:26 +0530
...
PI__ const s_productionInfo[] = 
{
     ...
     {292, 3}, // 14: basic_block (BB) ->  BB ':' executable_statement_list
     {293, 10}, // 15: if_else_clause (IF) ->  IF '(' relop_expression ')' GOTO BB ';' ELSE GOTO BB
     {294, 3}, // 16: relop_expression (LT) ->  relop_expression LT relop_expression
     {294, 3}, // 17: relop_expression (LE) ->  relop_expression LE relop_expression
     {294, 3}, // 18: relop_expression (GT) ->  relop_expression GT relop_expression
     {294, 3}, // 19: relop_expression (GE) ->  relop_expression GE relop_expression
     {294, 3}, // 20: relop_expression (EQ) ->  relop_expression EQ relop_expression
     {294, 3}, // 21: relop_expression (NE) ->  relop_expression NE relop_expression
     {294, 1}, // 22: relop_expression ->  variable
     {294, 1}, // 23: relop_expression ->  constant
     {295, 1}, // 24: executable_statement_list ->  assignment_statement_list
     {295, 3}, // 25: executable_statement_list (RETURN) ->  assignment_statement_list RETURN ';'
     {295, 4}, // 26: executable_statement_list (GOTO) ->  assignment_statement_list GOTO BB ';'
     {295, 3}, // 27: executable_statement_list (';') ->  assignment_statement_list if_else_clause ';'
     {296, 0}, // 28: assignment_statement_list ->  <empty>
     {296, 2}, // 29: assignment_statement_list ->  assignment_statement_list assignment_statement
     {297, 4}, // 30: assignment_statement (ASSIGN_OP) ->  variable ASSIGN_OP variable ';'
     {297, 4}, // 31: assignment_statement (ASSIGN_OP) ->  variable ASSIGN_OP constant ';'
     {297, 4}, // 32: assignment_statement (ASSIGN_OP) ->  variable ASSIGN_OP relop_expression ';'
     {298, 1}, // 33: variable (NAME) ->  NAME
     {299, 1}, // 34: constant (INTEGER_NUMBER) ->  INTEGER_NUMBER
     {300, 1}, // 35: program_$ ->  program
};
...
SR__ s_28[] =
{
    ...
    { {     260}, {  30} }, // RETURN              
    { {     264}, {  31} }, // GOTO                
    { {     293}, {  32} }, // if_else_clause      
    { {     297}, {  33} }, // assignment_statement
    { {     262}, {  34} }, // IF                  
    { {     298}, {  35} }, // variable            
    { {     259}, {  36} }, // NAME                
    { {       0}, { -24} },                        

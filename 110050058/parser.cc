// Generated by Bisonc++ V2.09.03 on Tue, 04 Feb 2014 01:58:40 +0530
...
PI__ const s_productionInfo[] = 
{
     ...
     {290, 3}, // 14: basic_block (BB) ->  BB ':' executable_statement_list
     {291, 10}, // 15: if_else_clause (IF) ->  IF '(' relop_expression ')' GOTO BB ';' ELSE GOTO BB
     {292, 3}, // 16: relop_expression ->  variable relop variable
     {292, 3}, // 17: relop_expression ->  constant relop variable
     {292, 3}, // 18: relop_expression ->  variable relop constant
     {292, 3}, // 19: relop_expression ->  constant relop constant
     {292, 3}, // 20: relop_expression ->  relop_expression relop variable
     {292, 3}, // 21: relop_expression ->  relop_expression relop constant
     {293, 1}, // 22: relop (LT) ->  LT
     {293, 1}, // 23: relop (LE) ->  LE
     {293, 1}, // 24: relop (GT) ->  GT
     {293, 1}, // 25: relop (GE) ->  GE
     {293, 1}, // 26: relop (NE) ->  NE
     {293, 1}, // 27: relop (EQ) ->  EQ
     {294, 1}, // 28: executable_statement_list ->  assignment_statement_list
     {294, 3}, // 29: executable_statement_list (RETURN) ->  assignment_statement_list RETURN ';'
     {294, 4}, // 30: executable_statement_list (GOTO) ->  assignment_statement_list GOTO BB ';'
     {294, 3}, // 31: executable_statement_list (';') ->  assignment_statement_list if_else_clause ';'
     {295, 0}, // 32: assignment_statement_list ->  <empty>
     {295, 2}, // 33: assignment_statement_list ->  assignment_statement_list assignment_statement
     {296, 4}, // 34: assignment_statement (ASSIGN_OP) ->  variable ASSIGN_OP variable ';'
     {296, 4}, // 35: assignment_statement (ASSIGN_OP) ->  variable ASSIGN_OP constant ';'
     {296, 4}, // 36: assignment_statement (ASSIGN_OP) ->  variable ASSIGN_OP relop_expression ';'
     {297, 1}, // 37: variable (NAME) ->  NAME
     {298, 1}, // 38: constant (INTEGER_NUMBER) ->  INTEGER_NUMBER
     {299, 1}, // 39: program_$ ->  program
};
...
SR__ s_28[] =
{
    ...
    { {     260}, {  30} }, // RETURN              
    { {     264}, {  31} }, // GOTO                
    { {     291}, {  32} }, // if_else_clause      
    { {     296}, {  33} }, // assignment_statement
    { {     262}, {  34} }, // IF                  
    { {     297}, {  35} }, // variable            
    { {     259}, {  36} }, // NAME                
    { {       0}, { -28} },                        

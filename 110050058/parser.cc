// Generated by Bisonc++ V2.09.03 on Tue, 04 Feb 2014 15:39:38 +0530
...
PI__ const s_productionInfo[] = 
{
     ...
     {294, 1}, // 21: variable (NAME) ->  NAME
     {295, 1}, // 22: constant (INTEGER_NUMBER) ->  INTEGER_NUMBER
     {296, 1}, // 23: program_$ ->  program
};
...
void Parser::executeAction(int production)
{
    ...
    switch (production)
    {
        ...
        case 14:
        { 
         if(d_vsp__[-2].string_value == NULL) {
         cout<<"$1 is null\n";
         exit(0);
         }

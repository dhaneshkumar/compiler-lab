// Generated by Bisonc++ V2.09.03 on Tue, 18 Mar 2014 19:47:35 +0530
...
PI__ const s_productionInfo[] = 
{
     ...
     {285, 2}, // 1: program ->  optional_declaration_list procedure_definition
     {286, 0}, // 2: optional_declaration_list ->  <empty>
     {286, 1}, // 3: optional_declaration_list ->  variable_declaration_list
     {287, 9}, // 4: procedure_definition (NAME) ->  NAME '(' ')' #0001 '{' optional_variable_declaration_list #0002 basic_block_list '}'
     {288, 0}, // 5: #0001 ->  <empty>
     {289, 0}, // 6: #0002 ->  <empty>
     {290, 0}, // 7: optional_variable_declaration_list ->  <empty>
     {290, 1}, // 8: optional_variable_declaration_list ->  variable_declaration_list
     {291, 1}, // 9: variable_declaration_list ->  variable_declaration
     {291, 2}, // 10: variable_declaration_list ->  variable_declaration_list variable_declaration
     {292, 2}, // 11: variable_declaration (';') ->  declaration ';'
     {293, 2}, // 12: declaration (INTEGER) ->  INTEGER NAME
     {294, 2}, // 13: basic_block_list ->  basic_block_list basic_block
     {294, 1}, // 14: basic_block_list ->  basic_block
     {295, 3}, // 15: basic_block (BBNUM) ->  BBNUM ':' executable_statement_list
     {296, 10}, // 16: if_else_clause (IF) ->  IF '(' relop_expression ')' GOTO BBNUM ';' ELSE GOTO BBNUM
     ...
     {297, 4}, // 19: executable_statement_list (GOTO) ->  assignment_statement_list GOTO BBNUM ';'
     {297, 3}, // 20: executable_statement_list (';') ->  assignment_statement_list if_else_clause ';'
     ...
     {299, 3}, // 23: relop_expression ('(') ->  '(' relop_expression ')'
     {299, 3}, // 24: relop_expression (LT) ->  relop_expression LT relop_expression
     {299, 3}, // 25: relop_expression (LE) ->  relop_expression LE relop_expression
     {299, 3}, // 26: relop_expression (GT) ->  relop_expression GT relop_expression
     {299, 3}, // 27: relop_expression (GE) ->  relop_expression GE relop_expression
     {299, 3}, // 28: relop_expression (EQ) ->  relop_expression EQ relop_expression
     {299, 3}, // 29: relop_expression (NE) ->  relop_expression NE relop_expression
     {299, 1}, // 30: relop_expression ->  variable
     {299, 1}, // 31: relop_expression ->  constant
     {300, 4}, // 32: assignment_statement (ASSIGN) ->  variable ASSIGN relop_expression ';'
     {301, 1}, // 33: variable (NAME) ->  NAME
     {302, 1}, // 34: constant (INTEGER_NUMBER) ->  INTEGER_NUMBER
     {303, 1}, // 35: program_$ ->  program
};
...
SR__ s_0[] =
{
    { { REQ_DEF}, {  7} },                             
    { {     285}, {  1} }, // program                  
    { {     286}, {  2} }, // optional_declaration_list
    { {     291}, {  3} }, // variable_declaration_list
    { {     292}, {  4} }, // variable_declaration     
    { {     293}, {  5} }, // declaration              
    { {     261}, {  6} }, // INTEGER                  
    { {       0}, { -2} },                             
};
...
{
    { { REQ_DEF}, {  6} },                                      
    { {     290}, { 16} }, // optional_variable_declaration_list
    { {     291}, { 17} }, // variable_declaration_list         
    { {     292}, {  4} }, // variable_declaration              
    { {     293}, {  5} }, // declaration                       
    { {     261}, {  6} }, // INTEGER                           
    { {       0}, { -7} },                                      
...
SR__ s_26[] =
{
    ...
    { {     260}, {  27} }, // RETURN              
    { {     264}, {  28} }, // GOTO                
    { {     296}, {  29} }, // if_else_clause      
    { {     300}, {  30} }, // assignment_statement
    { {     262}, {  31} }, // IF                  
    { {     301}, {  32} }, // variable            
    { {     259}, {  33} }, // NAME                
    { {       0}, { -17} },                        
...
{
    { { REQ_TOKEN}, {  7} },                    
    { {       299}, { 40} }, // relop_expression
    { {        40}, { 41} }, // '('             
    { {       301}, { 42} }, // variable        
    { {       302}, { 43} }, // constant        
    { {       259}, { 33} }, // NAME            
    { {       257}, { 44} }, // INTEGER_NUMBER  
    { {         0}, {  0} },                    
};

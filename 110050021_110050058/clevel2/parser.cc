// Generated by Bisonc++ V2.09.03 on Sat, 05 Apr 2014 22:52:42 +0530
...
PI__ const s_productionInfo[] = 
{
     ...
     {291, 2}, // 1: program ->  optional_declaration_list procedure_definition
     {292, 0}, // 2: optional_declaration_list ->  <empty>
     {292, 1}, // 3: optional_declaration_list ->  variable_declaration_list
     {293, 9}, // 4: procedure_definition (NAME) ->  NAME '(' ')' #0001 '{' optional_variable_declaration_list #0002 basic_block_list '}'
     {294, 0}, // 5: #0001 ->  <empty>
     {295, 0}, // 6: #0002 ->  <empty>
     {296, 0}, // 7: optional_variable_declaration_list ->  <empty>
     {296, 1}, // 8: optional_variable_declaration_list ->  variable_declaration_list
     {297, 1}, // 9: variable_declaration_list ->  variable_declaration
     {297, 2}, // 10: variable_declaration_list ->  variable_declaration_list variable_declaration
     {298, 2}, // 11: variable_declaration (';') ->  declaration ';'
     {299, 2}, // 12: declaration (INTEGER) ->  INTEGER NAME
     {299, 2}, // 13: declaration (FLOAT) ->  FLOAT NAME
     {299, 2}, // 14: declaration (DOUBLE) ->  DOUBLE NAME
     {300, 2}, // 15: basic_block_list ->  basic_block_list basic_block
     {300, 1}, // 16: basic_block_list ->  basic_block
     {301, 3}, // 17: basic_block (BBNUM) ->  BBNUM ':' executable_statement_list
     {302, 10}, // 18: if_else_clause (IF) ->  IF '(' relop_expression ')' GOTO BBNUM ';' ELSE GOTO BBNUM
     {303, 1}, // 19: executable_statement_list ->  assignment_statement_list
     {303, 3}, // 20: executable_statement_list (RETURN) ->  assignment_statement_list RETURN ';'
     {303, 4}, // 21: executable_statement_list (GOTO) ->  assignment_statement_list GOTO BBNUM ';'
     {303, 3}, // 22: executable_statement_list (';') ->  assignment_statement_list if_else_clause ';'
     {304, 0}, // 23: assignment_statement_list ->  <empty>
     {304, 2}, // 24: assignment_statement_list ->  assignment_statement_list assignment_statement
     {305, 1}, // 25: relop_expression ->  atomic
     {305, 3}, // 26: relop_expression (LT) ->  relop_expression LT relop_expression
     {305, 3}, // 27: relop_expression (LE) ->  relop_expression LE relop_expression
     {305, 3}, // 28: relop_expression (GT) ->  relop_expression GT relop_expression
     {305, 3}, // 29: relop_expression (GE) ->  relop_expression GE relop_expression
     {305, 3}, // 30: relop_expression (EQ) ->  relop_expression EQ relop_expression
     {305, 3}, // 31: relop_expression (NE) ->  relop_expression NE relop_expression
     {305, 3}, // 32: relop_expression ('+') ->  relop_expression '+' relop_expression
     {305, 3}, // 33: relop_expression ('-') ->  relop_expression '-' relop_expression
     {305, 3}, // 34: relop_expression ('*') ->  relop_expression '*' relop_expression
     {305, 3}, // 35: relop_expression ('/') ->  relop_expression '/' relop_expression
     {305, 1}, // 36: relop_expression ->  typecast_exp
     {305, 2}, // 37: relop_expression ('-') ->  '-' atomic
     {306, 1}, // 38: atomic ->  variable
     {306, 1}, // 39: atomic ->  constant
     {306, 3}, // 40: atomic ('(') ->  '(' relop_expression ')'
     {307, 1}, // 41: dataType (FLOAT) ->  FLOAT
     {307, 1}, // 42: dataType (DOUBLE) ->  DOUBLE
     {307, 1}, // 43: dataType (INTEGER) ->  INTEGER
     {308, 4}, // 44: typecast_exp ('(') ->  '(' dataType ')' atomic
     {309, 4}, // 45: assignment_statement (ASSIGN) ->  variable ASSIGN relop_expression ';'
     {310, 1}, // 46: variable (NAME) ->  NAME
     {311, 1}, // 47: constant (INTEGER_NUMBER) ->  INTEGER_NUMBER
     {311, 1}, // 48: constant (FLOAT_NUMBER) ->  FLOAT_NUMBER
     {312, 1}, // 49: program_$ ->  program
};
...
SR__ s_0[] =
{
    { { REQ_DEF}, {  9} },                             
    { {     291}, {  1} }, // program                  
    { {     292}, {  2} }, // optional_declaration_list
    { {     297}, {  3} }, // variable_declaration_list
    { {     298}, {  4} }, // variable_declaration     
    { {     299}, {  5} }, // declaration              
    { {     262}, {  6} }, // INTEGER                  
    { {     263}, {  7} }, // FLOAT                    
    { {     264}, {  8} }, // DOUBLE                   
...
{
    { { REQ_DEF}, {  8} },                                      
    { {     296}, { 20} }, // optional_variable_declaration_list
    { {     297}, { 21} }, // variable_declaration_list         
    { {     298}, {  4} }, // variable_declaration              
    { {     299}, {  5} }, // declaration                       
    { {     262}, {  6} }, // INTEGER                           
    { {     263}, {  7} }, // FLOAT                             
...
{
    { { DEF_RED}, {   3} },                             
    { {     303}, {  29} }, // executable_statement_list
    { {     304}, {  30} }, // assignment_statement_list
    { {       0}, { -23} },                             
};
...
SR__ s_30[] =
{
    ...
    { {     261}, {  31} }, // RETURN              
    { {     267}, {  32} }, // GOTO                
    { {     302}, {  33} }, // if_else_clause      
    { {     309}, {  34} }, // assignment_statement
    { {     265}, {  35} }, // IF                  
    { {     310}, {  36} }, // variable            
    { {     260}, {  37} }, // NAME                
    { {       0}, { -19} },                        
...
void Parser::executeAction(int production)
{
    ...
    switch (production)
    {
        ...
        case 18:
        {
         ...
         Goto_Ast *ab = new Goto_Ast(d_vsp__[-4].integer_value, get_line_number());
         Goto_Ast *ab1 = new Goto_Ast(d_vsp__[0].integer_value, get_line_number());
         store_goto( ab->get_bbno());
         store_goto( ab1->get_bbno());
         
         d_val__.ast = new Conditional_Ast(d_vsp__[-7].ast, ab, ab1, get_line_number());
         }
         }
        break;
        ...
        { 
         if (NOT_ONLY_PARSE)
         {
         Ast * ret = new Goto_Ast(d_vsp__[-1].integer_value, get_line_number());
         Goto_Ast * ret1 = new Goto_Ast( d_vsp__[-1].integer_value, get_line_number());
        ...
        case 26:
        {
         ...
         d_val__.ast = new Relational_Expr_Ast(d_vsp__[-2].ast, d_vsp__[0].ast, d_vsp__[-1].string_value, line);
        ...
        { 
         string k = "PLUS";
         int line = get_line_number();
         d_val__.ast = new Relational_Expr_Ast(d_vsp__[-2].ast, d_vsp__[0].ast, &k, line);
        ...
        case 37:
        {
         ...
         d_val__.ast = new Relational_Expr_Ast(NULL,d_vsp__[0].ast, &k, line);
        ...
        case 44:
        {
         ...
         d_val__.ast = new Typecast_Ast(d_vsp__[0].ast, get_line_number());
